...
public class ShopSystem : Singleton<ShopSystem>
{
	...
	public void UpdateSkinButtons(Car.Type type)
	{
		...
		{
			//_skinButtons[i].UpdateUI(type, GetSkinType(type, i), GetIcons(type)[i]);
	...
	public void SetSkin(Car.Type type, int skin)
	{
		...
		//{
		//case Car.Type.Bike:
		//	selectedBikeSkin = skin; 
		//	break;
		//case Car.Type.Boat:
		//	selectedBoatSkin = skin;
		//	break;
		//case Car.Type.Helicopter:
		//	selectedAirSkin = skin;
		//	break;
		//case Car.Type.Sportcar:
		//	selectedCarSkin = skin;
		//	break;
		//case Car.Type.Suv:
		//	selectedSuvSkin = skin;
		//	break;
		//case Car.Type.Truck:
		//	selectedTruckSkin = skin;
		//	break;
		//}
	}
